...
{
    /// <summary>
    /// A class dealing with file mime types.
    /// </summary>
    public class MimeTypeProvider : IMimeTypeProvider
    {
        // modified 2016/11/14 from https://github.com/samuelneff/MimeTypeMap cuz the nuget pkg is not strong named :(
        ...
        public string GetMimeType(string extension)
        {
            if (extension != null)
            {
                ...
                return __mappings.TryGetValue(extension, out mime) ? mime : UnknownType;
            }
            return UnknownType;
        }
